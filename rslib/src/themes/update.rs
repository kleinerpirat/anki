...
use crate::pb::themes::themes_for_update::CurrentTheme;
use crate::prelude::*;
...
impl Collection {
    ...
    pub fn get_themes_for_update(
        ...
        Ok(pb::themes::ThemesForUpdate {
            ...
            current_theme: Some(self.get_current_theme_for_update()?),
...
impl Collection {
    ...
    fn get_current_theme_for_update(&mut self) -> Result<CurrentTheme> {
