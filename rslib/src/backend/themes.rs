...
use crate::pb;
pub(super) use crate::pb::themes::theme_service::Service as ThemesService;
use crate::prelude::*;

impl ThemesService for Backend {
    fn get_theme(
        &self,
        input: pb::themes::ThemeId,
    ) -> Result<pb::themes::Theme> {
    ...
    fn get_themes_for_update(
        &self,
        input: pb::themes::ThemeId,
    ) -> Result<pb::themes::ThemesForUpdate> {
        self.with_col(|col| col.get_themes_for_update(input.into()))
    }
...
impl From<pb::themes::UpdateThemesRequest> for UpdateThemesRequest {
    fn from(c: pb::themes::UpdateThemesRequest) -> Self {
        UpdateThemesRequest {
            target_theme_id: c.target_theme_id.into(),
...
impl From<pb::themes::Theme> for Theme {
    fn from(c: pb::themes::Theme) -> Self {
        Theme {
            ...
            usn: c.usn.into(),
            vars: c.theme.unwrap_or_default(),
        }
    }
}
