        ...
        <DynamicallySlottable slotHost={Item} {api}>
            <Item>
                ...
                >
                    <SettingLabel
                        on:click={() =>
                            openHelp(Object.keys(settings).indexOf("learningSteps"))}
                        >{settings.learningSteps.title}</SettingLabel
                    >
                </StepsInputRow>
            </Item>
                ...
                >
                    <SettingLabel
                        on:click={() =>
                            ...
                            )}>{settings.graduatingInterval.title}</SettingLabel
                    >
                </SpinBoxRow>
            </Item>
            ...
            <Item>
                ...
                >
                    <SettingLabel
                        on:click={() =>
                            openHelp(Object.keys(settings).indexOf("easyInterval"))}
                        >{settings.easyInterval.title}</SettingLabel
                    >
                </SpinBoxRow>
            </Item>
            ...
            <Item>
                ...
                >
                    <SettingLabel
                        on:click={() =>
                            openHelp(Object.keys(settings).indexOf("insertionOrder"))}
                        >{settings.insertionOrder.title}</SettingLabel
                    >
                </EnumSelectorRow>
            </Item>
