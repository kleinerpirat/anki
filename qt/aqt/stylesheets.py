...
QTreeWidget,
QListView {{
    border: 1px solid {tm.var(colors.BORDER_DEFAULT)};
...
QComboBox::item {{
    color: {tm.var(colors.FG_DEFAULT)};
...
QTabBar::tab {{
  ...
  border-top-right-radius: {tm.var(props.BORDER_RADIUS)};
  padding: {tm.var(props.BORDER_RADIUS)} 10px;
  margin-bottom: 0px;
}}
...
QTabBar::tab:!selected {{
    margin-top: {tm.var(props.BORDER_RADIUS)};
    background: {tm.var(colors.CANVAS_DEFAULT)};
}}
QTabBar::tab {{
    min-width: 8ex;
    padding: {tm.var(props.BORDER_RADIUS)} 10px {tm.var(props.BORDER_RADIUS)} 10px;
}}
QTabBar::tab:selected {{
...
QTableView {{
    ...
    background: none;
    border: 2px solid {tm.var(colors.CANVAS_DEFAULT)};
    border-radius: {tm.var(props.BORDER_RADIUS)};
}}
QHeaderView::section {{
    border: 2px solid {tm.var(colors.CANVAS_DEFAULT)};
...
QHeaderView::section:first {{
    border-top: 2px solid {tm.var(colors.CANVAS_DEFAULT)};
    border-left: 2px solid {tm.var(colors.CANVAS_DEFAULT)};
    border-top-left-radius: {tm.var(props.BORDER_RADIUS)};
}}
QHeaderView::section:!first {{
    border-left: none;
...
QHeaderView::section:last {{
    border-top: 2px solid {tm.var(colors.CANVAS_DEFAULT)};
    border-right: 2px solid {tm.var(colors.CANVAS_DEFAULT)};
    border-top-right-radius: {tm.var(props.BORDER_RADIUS)};
}}
...
QScrollBar {{
    background-color: {tm.var(colors.CANVAS_DEFAULT)};
}}
QScrollBar::handle {{
    border-radius: {tm.var(props.BORDER_RADIUS)};
    background-color: {tm.var(colors.SCROLLBAR_BG_IDLE)};
}}
...
def win10_styles(tm: ThemeManager, buf: str) -> str:
    ...
    buf += f"""
QMenuBar {{
  border-bottom: 1px solid {tm.var(colors.BORDER_DEFAULT)};
  background: {tm.var(colors.CANVAS_DEFAULT) if tm.night_mode else "white"};
}}
    """
